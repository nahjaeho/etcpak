...
By adding the '--etc2_hq' argument, QuickETC2-HQ mode can be activated. Although this high-quality mode requires 1.6 times encoding time on average, compression quality can be improved to match that of ETCPACK's fast mode. Note that this mode is implemented only in the x64/AVX2 code.
